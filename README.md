...
# Tooling 
* We have implemented [Fractal](https://eprint.iacr.org/2019/1076.pdf) which is a highly optimized, FRI-based R1CS proof system, in Rust, based on the backend from the Winterfell Rust crates. See [this branch](https://github.com/Jasleen1/winter_fractal/tree/matrix_opt).
...
See inline comments in the `benches` files to see how to add more benchmarks. 
