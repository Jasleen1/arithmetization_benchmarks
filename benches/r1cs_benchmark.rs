...
use fractal_indexer::{snark_keys::{generate_prover_and_verifier_keys, ProverKey}, index::{Index, build_index_domains, IndexParams}, indexed_matrix::index_matrix};
use fractal_proofs::{FractalProverOptions, fft, get_power_series, StarkField, FieldElement, fields::f64::BaseElement, FractalOptions};
use fractal_prover::{prover::FractalProver, LayeredSubProver, LayeredProver};
use fractal_verifier::verifier::verify_layered_fractal_proof_from_top;
use winter_crypto::{ElementHasher, hashers::Blake3_256};
use winter_fri::FriOptions;
use winter_models::{jsnark_arith_parser::JsnarkArithReaderParser, jsnark_wire_parser::JsnarkWireReaderParser};

fn run_benchmarks<
    B: StarkField,
    E: FieldElement<BaseField = B>,
    H: ElementHasher + ElementHasher<BaseField = B>,
>(c: &mut Criterion, program: &str){
